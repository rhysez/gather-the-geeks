    ...
    <main className="space-y-24 mt-24">
      ...
      <section className="space-y-4">
        ...
        <p className="text-center">
          gather the geeks is a constant work-in-progress and i'd like to
          provide the best experience possible for my users.
        </p>
        <p className="text-center">
          therefore, i'm always welcoming of contributions to the official
          github repository. click the button below to head there.
        </p>
        <div className="flex justify-center">
          <Link
            className="bg-sea_mist rounded-full transition-all hover:bg-rose_red"
            href="https://github.com/rhysez/gather-the-geeks"
          >
            <Image
